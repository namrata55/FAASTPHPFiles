...
$support_comment = $_POST['comment'];
$username = $_POST['username'];

//$support_subject = "Others";
//$support_comment = " I'm not able to access the internet. Never expected such a thing from you'll.
//No red light. all are green as expected. this is 3rd or 4th time in 2-3 months that I'm experiencing hurdles while connecting to the internet. Not a good thing!";
//$username = "8747899999";
