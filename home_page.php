...
$result2 = "SELECT ROUND(SUM(amount * (price + tax)),2) as due_amount, min(paymentopt) as due_date FROM `rm_invoices` where invnum != ' ' and paid = '0000-00-00' and price > '0.00' and username = '" . $username . "' ";
...
//$tmp["lastname"] = $lastname;
//$tmp["mobile"] = $mobile;
//$tmp["flag_for_faast_prime"] = $flag_for_faast_prime_gokak;
//$tmp["faast_prime_member"] = $faast_prime_status;
//$tmp["faast_prime_request"] = $faast_prime_request;
//$tmp["email"] = $email;
//$tmp["srvname"] = $srvname;
