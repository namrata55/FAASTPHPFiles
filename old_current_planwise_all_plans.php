...
//$current_plan_name = "SMB GOKAK";
//$current_plan_descr = "Gokak";

$current_plan_name = $_POST['current_plan_name'];
$current_plan_descr = $_POST['current_plan_descr'];
$arr = explode(' ',trim($current_plan_name));

$result = "Select srvname, srvid, unitprice, trafficunitcomb, downrate, descr, nextsrvid from rm_services where enableburst = '1' and descr = '".$current_plan_descr."' order by srvid";
$row = array();
$json_output = array();
